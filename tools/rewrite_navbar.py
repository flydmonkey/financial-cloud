#!/usr/bin/env python3
"""Rewrite Navbar.vue with correct UTF-8 Chinese labels."""
from pathlib import Path

OUT = Path(__file__).resolve().parents[1] / "financial-cloud-ui" / "src" / "layout" / "components" / "Navbar.vue"
  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      <div class="right-menu-item">
        <span>__CURR_PERIOD__{{ termCurrent }}</span>
        <el-divider direction="vertical" />
        <span>__BOOK_SET__</span>
        <el-select
          v-model="currentSet"
          style="width: 250px;"
            ...
            <el-dropdown-menu>
              <el-dropdown-item>
                <router-link to="/user/profile">
                  ...
                  <span style="margin-left: 5px">__PROFILE__</span>
                </router-link>
              </el-dropdown-item>
              <el-dropdown-item>
              ...
              <el-dropdown-item style="border-top: 1px solid #888888;">
                <div @click="logout">
                  ...
                  <span style="margin-left: 5px">__LOGOUT__</span>
                </div>
              </el-dropdown-item>
            </el-dropdown-menu>
          </template>
...
const termCurrent = computed(() => {
  ...
  return yyyyMM[0] + '__YEAR__' + yyyyMM[1] + '__MONTH__'
})

currentSet.value = userStore.bookId;

function logout() {
  ElMessageBox.confirm('__CONFIRM_MSG__', '__CONFIRM_TITLE__', {
    confirmButtonText: '__OK__',
...
REPLACEMENTS = {
    "__CURR_PERIOD__": "\u5f53\u524d\u8d26\u671f\uff1a",
    "__BOOK_SET__": "\u8d26\u5957\uff1a",
    "__PROFILE__": "\u4e2a\u4eba\u4e2d\u5fc3",
    "__LOGOUT__": "\u9000\u51fa\u767b\u5f55",
    "__YEAR__": "\u5e74",
    "__MONTH__": "\u6708",
    "__CONFIRM_MSG__": "\u786e\u5b9a\u6ce8\u9500\u5e76\u9000\u51fa\u7cfb\u7edf\u5417\uff1f",
    "__CONFIRM_TITLE__": "\u63d0\u793a",
    "__OK__": "\u786e\u5b9a",
    "__CANCEL__": "\u53d6\u6d88",
}
...
def main() -> None:
    ...
    assert "\u5f53\u524d\u8d26\u671f" in verify
    assert "\u5e74" in verify and "\u6708" in verify
    assert "????" not in verify
    print(f"Wrote {OUT}")
    print(verify.splitlines()[11])
    print(verify.splitlines()[13])
