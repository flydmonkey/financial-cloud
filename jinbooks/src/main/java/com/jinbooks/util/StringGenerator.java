...
public class StringGenerator {
    ...
    public String uniqueGenerate() {
        ...
        String dateString = Base64.encode(dateFormat.format(currentDate).getBytes());
    ...
    public static String generateKey(String algorithm) {
        if (algorithm.equals(CipherAlgorithm.DES)) {
            return (new StringGenerator(8)).randomGenerate();
        } else if (algorithm.equals(CipherAlgorithm.AES)) {
            return (new StringGenerator(16)).randomGenerate();
        } else if (algorithm.equals(CipherAlgorithm.Blowfish)) {
            return (new StringGenerator(16)).randomGenerate();
        } else if (algorithm.equals(CipherAlgorithm.DESede)) {
