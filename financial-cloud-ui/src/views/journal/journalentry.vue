  ...
  <div class="app-container">
    ...
    >
      ...
      >
        ...
        <el-form-item
          :label="$t('jbx.journalentry.accId')"
          prop="accId"
          required
        >
          <el-select
        ...
        <el-form-item
          v-show="false"
          :label="$t('jbx.journalentry.accCode')"
          prop="accCode"
        >
          <el-input
        ...
        <el-form-item
          v-show="false"
          :label="$t('jbx.journalentry.category.category')"
          prop="category"
        >
          <el-input
        ...
        <el-form-item
          prop="direction"
          :label="$t('jbx.journalentry.direction')"
          required
        >
          <el-radio-group v-model="form.direction">
            <el-radio-button value="i">
              {{ t('jbx.journalentry.income') }}
            </el-radio-button>
            <el-radio-button value="e">
              {{ t('jbx.journalentry.expenditure') }}
            </el-radio-button>
            <el-radio-button
              v-if="form.initBalance"
              value="o"
            >
              初始化
            </el-radio-button>
