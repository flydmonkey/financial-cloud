...
public class DiplexCacheManager  implements DiplexCache{
	 ...
	 */
	public DiplexCacheManager(StringRedisTemplate redis, JsonMapper jsonMapper) {
		this.redisCache = true;
		this.inMemoryDiplexCache = new InMemoryDiplexCache();
		this.redisDiplexCache = new RedisDiplexCache(redis, jsonMapper, validitySeconds);
	 ...
	 * @param connectionFactory
	 */
	public DiplexCacheManager(StringRedisTemplate redis, JsonMapper jsonMapper, int validitySeconds) {
		this.redisCache = true;
