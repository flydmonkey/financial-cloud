...
import com.jinbooks.repository.statement.StatementBalanceSheetItemMapper;
import com.jinbooks.repository.statement.StatementBalanceSheetMapper;
...
import com.jinbooks.dto.statement.StatementBalanceSheetExport;
...
public class StatementBalanceSheetServiceImpl implements StatementBalanceSheetService {
    ...
    public Message<StatementBalanceSheet> balanceSheet(StatementParamsDto dto, boolean save) {
        ...
        if (save) {
            ...
            Db.saveBatch(balanceSheetItems);
        }
