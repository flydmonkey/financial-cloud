<template>
  ...
  >
    ...
    <el-form-item
      prop="displayName"
      :label="$t('jbx.password.displayName')"
      :required="true"
    >
      <el-input
    ...
    <el-form-item
      ...
      :label="$t('jbx.password.confirmPassword')"
      :required="true"
    >
      <el-input
