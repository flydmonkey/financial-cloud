...
const tableCheckData = [
  {
    item: '检查银行和现金',
    content: '【请外部完成】余额与银行对账单和库存现金盘点表比对，与出纳日记账对比（系统暂无银行余额调节）',
  },
  {
    item: '检查往来款项',
    content: '【请外部完成】核对供应商和客户的往来款项；催收与清理（系统暂无核销/账龄）',
  },
  {
    item: '检查存货',
    content: '【请外部完成】账实一致（本产品不含进销存）',
  },
  {
    item: '检查主营业务收入',
    content: '【请外部完成】明细账本期发生额与税控系统发票统计表及无票收入备查账勾稽',
  },
  {
    item: '检查工资、五险一金',
    content: '检查工资是否计提发放、检查五险一金是否计提和缴纳（可结合薪资模块）',
  },
  {
    item: '检查折旧、摊销',
    content: '检查固定资产是否折旧；费用摊销、无形资产摊销请外部核对（系统固资折旧可用）',
  },
  {
    item: '检查利息费用',
    content: '检查利息是否计提',
  ...
  {
    item: '检查税费',
    content: '增值税是否结转、税金及附加是否计提，企业所得税是否计提（系统暂无税费结转向导，请人工确认）',
  },
  {
    item: '检查原始凭证',
    content: '除结转和错账更正可以不附原始凭证，费用是否授权审批；附件影像请外部归档',
  },
  {
    item: '检查科目余额表',
    content: '检查每一科目的发生金额、方向、余额大小、方向是否有异常；可从余额表穿透至明细账、记账凭证核实',
  },
];
