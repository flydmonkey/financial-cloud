    ...
    <template #default>
      <div class="queryForm">
        ...
        >
          ...
          >
            <el-radio-group
              v-model="queryParams.cashFlowItemType"
              @change="handleType"
            >
              <el-radio-button
                label="主表项目"
          ...
          <el-form-item label="现金流量项">
            <el-select
              v-model="queryParams.cashFlowItemCode"
              clearable
              style="width: 240px"
            >
              <el-option
        ...
        >
          ...
          >
            <template #default="scope">
              ...
              <el-select
                v-else
                v-model="scope.row.cashFlowItemCode"
                style="width: 100%"
                placement="bottom"
      ...
      <edit-form
        ...
        @dialog-of-closed-methods="dialogOfClosedMethodsDrawer"
      />
    </template>
    <template #footer>
      <div style="flex: auto">
