    ...
    <el-card class="common-card query-box">
      <div class="queryForm">
        ...
        >
          ...
          >
            <el-radio-group
              v-model="queryParams.assistType"
              @change="handleQuery"
            >
              <el-radio-button
                v-for="(aux, index) in subjects_auxiliary"
                :key="index"
                :label="aux.label"
                :value="aux.value"
              />
    ...
    >
      ...
      <template #default>
        ...
        >
          ...
          >
            <el-input
              v-model="form.assistCode"
              :placeholder="'请输入编码,建议以'+form.assistCodePlaceholder+'开头'"
            />
          </el-form-item>
          ...
          <el-form-item
            v-if="form.assistType === '5'"
            label="部门"
            prop="dept"
          >
            <el-select v-model="form.dept">
              <el-option
                v-for="item in assistDeptList"
                :label="item.assistName"
                :value="item.assistCode"
              />
            </el-select>
          </el-form-item>

          <el-form-item
            v-if="form.assistType === '6'"
            label="规格"
            prop="spec"
          >
            <el-input
