...
public enum StatementErrorCode implements ErrorCode {
    ...
    BALANCE_SHEET_TRIAL_BALANCE_FAILED(513013, MessageKeys.Statement.BALANCE_SHEET_TRIAL_BALANCE_FAILED),
    INCOME_STATEMENT_FORMULA_FAILED(513014, MessageKeys.Statement.INCOME_STATEMENT_FORMULA_FAILED),
    CASH_FLOW_RECONCILIATION_FAILED(513015, MessageKeys.Statement.CASH_FLOW_RECONCILIATION_FAILED);
