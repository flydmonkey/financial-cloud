    ...
    <el-card class="common-card query-box">
      ...
      >
        ...
        <div class="btn-form-right">
          <el-button
            type="primary"
            @click="handleAdd(null, 'asset')"
          >
            添加一级资产项
          </el-button>
          <el-button
            type="success"
            @click="handleAdd(null, 'liability')"
          >
            添加一级负债和所有者权益项
          </el-button>
        </div>
        ...
        >
          <template #default="scope">
            <div v-if="scope.row.itemName != ''">
              <el-tooltip
                v-if="scope.row.level > 1 || (scope.row.itemCode && scope.row.itemCode.endsWith('00'))"
                content="新增"
              >
                <el-button
                  type="primary"
                  link
                  icon="Plus"
                  @click="handleAdd(scope.row, 'asset')"
                />
              </el-tooltip>
              <el-tooltip
                v-if="scope.row.level > 1 || (scope.row.itemCode && !scope.row.itemCode.endsWith('00'))"
              ...
              >
                <el-button
                  ...
                  link
                  icon="Edit"
                  @click="handleEdit(scope.row, 'asset')"
                />
              </el-tooltip>
            ...
            <div v-if="scope.row.liabilityItemName !='' ">
              ...
              >
                <el-button
                  ...
                  link
                  icon="Plus"
                  @click="handleAdd(scope.row, 'liability')"
                />
              </el-tooltip>
              <el-tooltip
                v-if="scope.row.liabilityLevel > 1 || (scope.row.liabilityItemCode && !scope.row.liabilityItemCode.endsWith('00'))"
              ...
              >
                <el-button
                  ...
                  link
                  icon="Edit"
                  @click="handleEdit(scope.row, 'liability')"
                />
              </el-tooltip>
              <el-tooltip content="移除">
                <el-button
                  ...
                  link
                  icon="Delete"
                  @click="handleDel(scope.row, 'liability')"
                />
              </el-tooltip>
            </div>
          </template>
      ...
      <template #default>
        ...
        >
          ...
          >
            <el-radio-group
              v-model="form.level"
              :disabled="!form.parentItemCode || level === 1"
            >
              <el-radio-button
                label="本级"
                :value="level"
