  ...
  <div class="app-container">
    ...
    <el-card class="common-card">
      ...
      >
        <el-table-column
          prop="syncId"
          :label="$t('jbx.history.synchronizerSyncid')"
          align="center"
          min-width="50"
        />
        <el-table-column
          prop="syncName"
          :label="$t('jbx.history.synchronizerSyncname')"
          align="center"
          min-width="120"
        />
        <el-table-column
        ...
        <el-table-column
          prop="objectType"
          :label="$t('jbx.history.synchronizerObjecttype')"
          align="center"
          min-width="120"
        />
        <el-table-column
        ...
        <el-table-column
          prop="syncTime"
          :label="$t('jbx.history.synchronizerSynctime')"
          align="center"
          min-width="120"
        />
        <el-table-column
