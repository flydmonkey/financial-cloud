      ...
      >
        ...
        >
          工资金额 {{ (form.payBasic +
            ...
            form.overtime +
            form.allowance +
            form.backPay).toFixed(2) }} 应发金额 {{ (form.payAmount||0.00).toFixed(2) }}
        </h4>
        <el-row :gutter="20">
          <el-col
          ...
          <el-col :span="span">
            <el-form-item label="奖金">
              <el-input-number
                ...
                :precision="2"
                style="width: 100%"
                :disabled="form.employeeType === 'PARTTIME'"
              >
                <template #suffix>
                  <span>元</span>
                </template>
        ...
        >
          应扣金额 {{ (form.attendance
            +form.otherDeductions
            +form.totalSocialInsurance
            +form.providentFund
            +form.personalTax).toFixed(2) }}
        </h4>
        <el-row :gutter="20">
          <el-col :span="span">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="span">
            <el-form-item label="公司成本">
              <el-input
                v-model="form.businessExpenditureCosts"
                :precision="2"
                style="width: 100%"
                disabled
              >
